...
public:
	...
	clsDate IncreaseDateByOneMonth(clsDate& Date)
	{
		...
		// example if date is 31/1/2026 increasing one month should not be 31/2/2026, it should
		// be 28/2/2026
	...
	static clsDate DecreaseDateByOneMonth(clsDate& Date)
	{
		...
		//last check day in date should not exceed max days in the current month
	   // example if date is 31/3/2026 decreasing one month should not be 31/2/2026, it should
	   // be 28/2/2026
		short NumberOfDaysInCurrentMonth = NumberOfDaysInAMonth(Date.Month, Date.Year);
		if (Date.Day > NumberOfDaysInCurrentMonth)
		{
	...
	static string GetSystemDateTimeString()
	{
		...
		return string( to_string(Day) + "/" + to_string(Month) + "/" +
