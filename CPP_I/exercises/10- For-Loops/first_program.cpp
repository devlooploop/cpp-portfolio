...
/*
	Create a program that deals with an array of integers using multiple functions.
	The program should ask the user how many numbers they want to enter (from 1 to 100), 
	then read those numbers into an array, print them, and finally calculate and display both their sum and average.
*/ 
